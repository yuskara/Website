...
function Video(){
    return(
        <div className='CVBaldeTemp2-video'>
            ...
            <div className='CVBaldeTemp2-video-pdf'> <a href='#'>Generate PDF</a></div>
        </div>
    )
