  ...
  return (
    <header className="rest_header">
         <div className="rest_header-title">
             ...
             <p className="rest_header-days"> Monday - Friday: <span className="rest_header-hours">08:00 A.M. - 23:00 P.M.</span></p>
             <p className="rest_header-days"> Weekends: <span className="rest_header-hours">08:00 A.M. - 02:00 P.M.</span></p>
         </div>
     </header>
 );
}
