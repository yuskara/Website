...
function MenuToggle({ isOpen, aboutToggle }) {
  return (
    <ToggleContainer isOpen={isOpen} onClick={aboutToggle}>
      ...
      <ToggleWrapper>
        <ToggleMenu>
          <ToggleLink to='/' onClick={aboutToggle}>
            Home
          </ToggleLink>
        </ToggleMenu>
        <ToggleMenu>
          <ToggleLink to='/signUp' onClick={aboutToggle}>
            Sign Up
          </ToggleLink>
        </ToggleMenu>
        <ToggleMenu>
          <ToggleLink to='/login' onClick={aboutToggle}>
            Sign In
          </ToggleLink>
        </ToggleMenu>
        <ToggleBtnWrap>
          <ToggleBtn to='/contact' onClick={aboutToggle}>
            Contact Us
          </ToggleBtn>
        </ToggleBtnWrap>
      </ToggleWrapper>
